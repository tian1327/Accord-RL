...
use_gurobi = False
RUN_NUMBER = 200 #Change this field to set the seed for the experiment, and change the CONSTRAINT value
...
for sim in range(NUMBER_SIMULATIONS):
    ...
    util_methods = utils(EPS, DELTA, M, P, R, C1, C2, INIT_STATE_INDEX, 
                         EPISODE_LENGTH, N_STATES, N_ACTIONS, ACTIONS_PER_STATE, CONSTRAINT, Cb, CONSTRAINT, Cb, use_gurobi) # set the utility methods for each run
    ...
    for episode in range(NUMBER_EPISODES):
        ...
        print('Episode {}, ObjRegt = {:.2f}, Cons1Regt = {:.2f}, Cons2Regt = {:.2f},  #Infeas = {}, Time = {:.2f}'.format(
              episode, ObjRegret2[sim, episode], Con1Regret2[sim, episode], Con2Regret2[sim, episode], NUMBER_INFEASIBILITIES[sim, episode], dtime))
