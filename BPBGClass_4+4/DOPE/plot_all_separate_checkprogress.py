...
plt.savefig("BPBGClass_obj_regrets_progress.png", dpi=300, facecolor='w', edgecolor='w')
...
plt.savefig("BPBGClass_cons_regrets_progress.png", dpi=300, facecolor='w', edgecolor='w')
